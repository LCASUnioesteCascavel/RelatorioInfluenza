...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{Figuras/Resultados/Casos_Observados_Acumulados.png}
...
\begin{figure}[H]
  ...
  \begin{minipage}{.45\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{Figuras/Resultados/01-07-2009.png}
    \captionsetup{labelformat=empty}
    \captionof{figure}{Dia 1 de Julho de 2009}
  \end{minipage}%
  \begin{minipage}{.45\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{Figuras/Resultados/01-08-2009.png}
    \captionsetup{labelformat=empty}
    \captionof{figure}{Dia 1 de Agosto de 2009}
  \end{minipage}
  \begin{minipage}{.45\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{Figuras/Resultados/01-09-2009.png}
    \captionsetup{labelformat=empty}
  ...
  \begin{minipage}{.45\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{Figuras/Resultados/01-10-2009.png}
    \captionsetup{labelformat=empty}
    \captionof{figure}{Dia 1 de Outubro de 2009}
  \end{minipage}
  \begin{minipage}{.45\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{Figuras/Resultados/01-11-2009.png}
    \captionsetup{labelformat=empty}
    \captionof{figure}{Dia 1 de Novembro de 2009}
  \end{minipage}%
  \begin{minipage}{.45\textwidth}
    \centering
    \includegraphics[width=1.0\textwidth]{Figuras/Resultados/01-12-2009.png}
    \captionsetup{labelformat=empty}
...
every last row/.style={after row=\bottomrule},
display columns/2/.style={string type, column type=l}
]{Figuras/Resultados/0002/Entradas/MonteCarlo_0/Geral.csv}
\end{center}
