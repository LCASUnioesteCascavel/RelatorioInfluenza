...
\lstinputlisting[caption=Função Movimentação, label=cod:movimentacao, captionpos=b, language=C++]{Codigos/EstruturasDadosEstrategias/Fontes/Movimentacao.cpp}
...
\lstinputlisting[caption=Função Contato, label=cod:contato, captionpos=b, language=C++]{Codigos/EstruturasDadosEstrategias/Fontes/Contato.cpp}
...
\lstinputlisting[caption=Função Transição, label=cod:transicao, captionpos=b, language=C++]{Codigos/EstruturasDadosEstrategias/Fontes/Transicao.cpp}
...
\subsubsection{Macros à Implementação das Operações \textit{bitstring}}
...
\lstinputlisting[title=Macros para captura e configuração de atributos do agente, captionpos=b, language=C++]{Codigos/EstruturasDadosEstrategias/Macros.cpp}
