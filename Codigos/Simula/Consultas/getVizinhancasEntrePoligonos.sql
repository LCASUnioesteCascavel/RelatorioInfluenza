...
CREATE OR REPLACE FUNCTION getVizinhancasEntrePoligonos(tabelaPoligonos varchar)
...
BEGIN
	...
	'select * from ( 
		...
		from %s as a, %s as b 
		where a.lote < b.lote and a.quadra = b.quadra and a.quadra != ''0000'' 
		...
		select a.lote as l1, a.quadra as q1, b.lote as l2, b.quadra as q2 
		from %s as a, %s as b 
		where a.lote < b.lote and a.quadra like ''G%%'' and b.quadra like ''G%%'' 
		and a.quadra != b.quadra and st_dwithin(a.geom, b.geom, 2)
