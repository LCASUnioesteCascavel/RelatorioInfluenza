...
ref1 integer, id2 bigint, q2 varchar, l2 varchar, x2 float, y2 float, ref2 integer) AS
$$
BEGIN
	RETURN QUERY
	EXECUTE format(
  ...
  a.ref ref1, 
		b.id id2, b.quadra q2, b.lote l2, st_x(b.geom) x2, st_y(b.geom) y2, b.ref ref2 
	...
	where a.quadra = c.q1 and a.lote = c.l1 and b.quadra = c.q2 and b.lote = c.l2 and 
	      st_dwithin(a.geom, b.geom, greatest(a.ref, b.ref) * sqrt(2) + 0.1) 
        and b.id != a.id'
